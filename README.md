...
<figure style="text-align: center; margin-bottom: 2rem;">
  <img src="screenshots/main-page.png" alt="Главная страница" style="max-width: 50px; width: 100%; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.15); display: block; margin: 0 auto;">
...
<figure style="text-align: center; margin-bottom: 2rem;">
  <img src="screenshots/post-page.png" alt="Страница поста" style="max-width: 50px; width: 100%; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.15); display: block; margin: 0 auto;">
...
<figure style="text-align: center; margin-bottom: 2rem;">
  <img src="screenshots/create-post.png" alt="Создание поста" style="max-width: 50px; width: 100%; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.15); display: block; margin: 0 auto;">
...
<figure style="text-align: center; margin-bottom: 2rem;">
  <img src="screenshots/profile-page.png" alt="Профиль пользователя" style="max-width: 50px; width: 100%; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.15); display: block; margin: 0 auto;">
...
<figure style="text-align: center; margin-bottom: 2rem;">
  <img src="screenshots/admin-panel.png" alt="Панель администратора" style="max-width: 50px; width: 100%; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.15); display: block; margin: 0 auto;">
